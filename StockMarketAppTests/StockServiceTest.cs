...
namespace StockMarketAppTests
{
    public class StockServiceTest
    {
        ...
        [Fact]
        public async Task CreateBuyOrder_InvalidPriceMinimum()
        {
            //Arrange
            BuyOrderRequest buyOrderRequest = _fixture.Build<BuyOrderRequest>()
        ...
        [Fact]
        public async Task CreateBuyOrder_InvalidPriceMaximum()
        {
            //Arrange
            BuyOrderRequest buyOrderRequest = _fixture.Build<BuyOrderRequest>()
        ...
        [Fact]
        public async Task CreateBuyOrder_DateAndTimeOfOrderIsInvalid()
        {
            //Arrange
            BuyOrderRequest buyOrderRequest = _fixture.Build<BuyOrderRequest>()
        ...
        [Fact]
        public async Task CreateBuyOrder_ProperOrderDetails()
        {
            //Arrange
            BuyOrderRequest buyOrderRequest = _fixture.Build<BuyOrderRequest>()
                .Create();
        ...
        [Fact]
        public async Task CreateSellOrder_InvalidPriceMinimum()
        {
            //Arrange
            SellOrderRequest sellOrderRequest = _fixture.Build<SellOrderRequest>()
                .With(temp => temp.Quantity, (uint)1000).With(temp => temp.Price, (uint)0).Create();
        ...
        [Fact]
        public async Task CreateSellOrder_InvalidPriceMaximum()
        {
            //Arrange
            SellOrderRequest sellOrderRequest = _fixture.Build<SellOrderRequest>()
        ...
        // it should be equal or newer date than 2000-01-01), it should throw ArgumentException
        [Fact]
        public async Task CreateSellOrder_DateAndTimeOfOrderIsInvalid()
        {
            //Arrange
            SellOrderRequest sellOrderRequest = _fixture.Build<SellOrderRequest>()
                .With(temp => temp.Quantity, (uint)1000).With(temp => temp.Price, (uint)100)
        ...
        [Fact]
        public async Task CreateSellOrder_ProperOrderDetails()
        {
            //Arrange
            SellOrderRequest sellOrderRequest = _fixture.Build<SellOrderRequest>()
                .Create();
        ...
        [Fact]
        public async Task GetBuyOrders_AddingProperValues()
        {
            //Arrange
        ...
        public async Task GetSellOrders_EmptyList()
        {
            ...
            //Assert
            sellOrders.Count.Should().Be(0);
        }

        //When you first add few sell orders using CreateSellOrder() method; and then invoke GetAllSellOrders() method;
        //the returned list should contain all the same sell orders
        [Fact]
        public async Task GetSellrders_AddingProperValues()
        {
            //Arrange
